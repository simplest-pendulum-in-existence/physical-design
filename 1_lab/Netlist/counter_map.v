...
// Generated by Cadence Genus(TM) Synthesis Solution 21.18-s082_1
// Generated on: Oct  1 2025 03:02:20 PKT (Sep 30 2025 22:02:20 UTC)
...
// Generated by Cadence Genus(TM) Synthesis Solution 21.18-s082_1
// Generated on: Oct  1 2025 03:03:28 PKT (Sep 30 2025 22:03:28 UTC)
...
module counter(clk, reset, count);
  ...
  wire clk, reset;
  wire [3:0] count;
  wire n_0, n_2, n_4, n_5, n_7, n_9, n_12;
  DFCNQD1 \count_reg[3] (.CDN (n_9), .CP (clk), .D (n_12), .Q
       (count[3]));
  DFCNQD1 \count_reg[2] (.CDN (n_9), .CP (clk), .D (n_5), .Q
       (count[2]));
  OA21D1 g83__5107(.A1 (n_4), .A2 (count[2]), .B (n_7), .Z (n_5));
  DFCNQD1 \count_reg[1] (.CDN (n_9), .CP (clk), .D (n_2), .Q
       (count[1]));
  ND2D1 g85__6260(.A1 (n_4), .A2 (count[2]), .ZN (n_7));
  IAO21D1 g86__4319(.A1 (count[0]), .A2 (count[1]), .B (n_4), .ZN
       (n_2));
  AN2XD1 g88__8428(.A1 (count[0]), .A2 (count[1]), .Z (n_4));
  CKND0 g92(.I (reset), .ZN (n_9));
  XNR2D1 g2(.A1 (n_7), .A2 (count[3]), .ZN (n_12));
  DFCND1 \count_reg[0] (.CDN (n_9), .CP (clk), .D (n_0), .Q (count[0]),
       .QN (n_0));
endmodule
